...
# Global Values
date = "20250730"                # Date of contract (YYYY-MM-DD)
...
CE_SELL_REENTRY = 2
PE_SELL_REENTRY = 2
ATM_CALL_SELL = 0                       # How far away call position is (2 means that its $10 away from current price)
ATM_PUT_SELL = 0
call_sl_sell = 30
put_sl_sell = 30
sell_put_entry_price_changes_by = 30      # What % should put entry premium price should change by to update the trailing %
sell_put_change_sl_by = 10                # What % of entry price should put sl change when trailing stop loss updates
sell_call_entry_price_changes_by = 30     # What % should call entry premium price should change by to update the trailing %
...
CE_BUY_REENTRY = 2
PE_BUY_REENTRY = 2
ATM_CALL_BUY = 1                       # How far away call position is (2 means that its $10 away from current price)
ATM_PUT_BUY = 1                         # How far away put position is (2 means that its $10 away from current price)
...
buy_put_entry_price_changes_by = 30      # What % should put entry premium price should change by to update the trailing %
buy_put_change_sl_by = 10                # What % of entry price should put sl change when trailing stop loss updates
buy_call_entry_price_changes_by = 30     # What % should call entry premium price should change by to update the trailing %

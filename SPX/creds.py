...
# Global Values
date = "20250707"                # Date of contract (YYYY-MM-DD)
...
exit_minute = 53                    # Exit time in minutes
...
call_sl_buy = 5                            # From where the call stop loss should start from (15 here means 15% of entry price)
put_sl_buy = 5                         # From where the put stop loss should start from (15 here means 15% of entry price)
